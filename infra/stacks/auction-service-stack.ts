...
export class AuctionServiceStack extends base.BaseStack {
  constructor(
    ...
    const createAuctionLambda = new nodelambda.NodejsFunction(
      ...
      {
        entry:
          "codes/lambda/src/Auction/usecases/create-auction/adapter/in/create-auction.controller.ts",
        handler: "handler",
        memorySize: 128,
    ...
    const getAuctionLambda = new nodelambda.NodejsFunction(
      ...
      {
        entry:
          "codes/lambda/src/createAuction/adapter/in/web/getAuction.Controller.ts",
        handler: "handler",
        memorySize: 128,
        timeout: cdk.Duration.minutes(2),
      }
